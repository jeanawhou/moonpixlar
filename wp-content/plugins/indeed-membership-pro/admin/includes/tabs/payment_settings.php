			...
			<div class="ihc-stuffbox">
				...
				<div class="ihc-stuffbox">				
					...
					<div class="inside">
						...
						<div class="iump-form-line">
							<?php 
								_e("<strong>Important:</strong> set your Web Hook URL to: ");
								echo '<strong>'.IHC_URL . 'stripe_webhook.php'.'</strong>';
							?>
						</div> 									
						<div class="ihc-wrapp-submit-bttn iump-submit-form">
							<input type="submit" value="<?php _e('Save', 'ihc');?>" name="ihc_save" class="button button-primary button-large" />
					...
					<div class="inside">
						...
						<div class="iump-form-line">
							<?php 
								...
								echo '<strong>'.IHC_URL . 'authorize_response.php'.'</strong>';
							?>
						</div> 	
					...
					<div class="inside">
						...
						<div class="iump-form-line">
							<?php 
								...
								echo '<strong>'.admin_url("admin-ajax.php") . "?action=ihc_twocheckout_ins".'</strong>';
							?>
						</div> 					
