					...
					<div class="ihc-stuffbox">
						...
						<div class="inside">		
							<div class="iump-form-line">			
								<h4><?php _e("Once all Settings are properly done, Activate Facebook Login to become available for further use.", "ihc");?></h4>				
				...
				?>
								...
								<form action="" method="post">
									<div class="ihc-stuffbox">
										...
										<div class="inside">		
											<div class="iump-form-line">
												<h4><?php _e("Once all Settings are properly done, Activate Twitter Login to become available for further use.", "ihc");?></h4>							
												<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
				...
				?>
							...
							<form action="" method="post">
								<div class="ihc-stuffbox">
									...
									<div class="inside">		
										<div class="iump-form-line">
											<h4><?php _e("Once all Settings are properly done, Activate LinkedIn Login to become available for further use.", "ihc");?></h4>							
											<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
			...
			case 'tbr':
					...
					<form action="" method="post">
						<div class="ihc-stuffbox">
							...
							<div class="inside">		
								<div class="iump-form-line">	
									<h4><?php _e("Once all Settings are properly done, Activate Tumblr Login to become available for further use.", "ihc");?></h4>						
									<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
			...
			case 'ig':
				...
				<form action="" method="post">
					<div class="ihc-stuffbox">
						...
						<div class="inside">		
							<div class="iump-form-line">	
								<h4><?php _e("Once all Settings are properly done, Activate Instagram Login to become available for further use.", "ihc");?></h4>						
								<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
			...
			case 'vk':
				...
				<form action="" method="post">
					<div class="ihc-stuffbox">
						...
						<div class="inside">		
							<div class="iump-form-line">	
								<h4><?php _e("Once all Settings are properly done, Activate Vkontakte Login to become available for further use.", "ihc");?></h4>						
								<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
			...
			case 'goo':
				...
				<form action="" method="post">
					<div class="ihc-stuffbox">
						...
						<div class="inside">		
							<div class="iump-form-line">			
								<h4><?php _e("Once all Settings are properly done, Activate Google Login to become available for further use.", "ihc");?></h4>					
								<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
