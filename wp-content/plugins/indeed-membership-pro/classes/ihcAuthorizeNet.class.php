		...
		public function payment_fields(){
			...
			if (!empty($ihc_pay_error)){
				if (!empty($ihc_pay_error['not_empty'])){
					$str .= '<div class="ihc-register-notice">' . $ihc_pay_error['not_empty'] . '</div>';		
				}
				if (!empty($ihc_pay_error['wrong_expiration'])){
					$str .= '<div class="ihc-register-notice">' . $ihc_pay_error['wrong_expiration'] . '</div>';		
				}
				if (!empty($ihc_pay_error['invalid_card'])){
					$str .= '<div class="ihc-register-notice">' . $ihc_pay_error['invalid_card'] . '</div>';		
				}
				if (!empty($ihc_pay_error['invalid_first_name'])){
					$str .= '<div class="ihc-register-notice">' . $ihc_pay_error['invalid_first_name'] . '</div>';		
				}
				if (!empty($ihc_pay_error['invalid_last_name'])){
					$str .= '<div class="ihc-register-notice">' . $ihc_pay_error['invalid_last_name'] . '</div>';		
				}														
			}		
